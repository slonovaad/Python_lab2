...
from src.constants.constants import TRASH_DIRECTORY, HISTORY_FILE


class MakeReserveCopyTestCase(unittest.TestCase):
    """Тесты для функции make_reserve_copy"""

    def test_file_when_trash_dir_and_history_exists(self):
        with (patch("src.make_reserve_copy.open") as mock_open,
    ...
    def test_file_when_trash_dir_and_history_not_exists(self):
        with (patch("src.make_reserve_copy.open") as mock_open,
              patch("os.path.exists") as mock_exists,
              patch("os.path.isfile") as mock_isfile,
              patch("os.path.isdir") as mock_isdir,
    ...
    def test_dir_when_trash_dir_and_history_exists(self):
        with (patch("src.make_reserve_copy.open") as mock_open,
              patch("os.path.exists") as mock_exists,
              patch("os.path.isfile") as mock_isfile,
              patch("os.path.isdir") as mock_isdir,
    ...
    def test_dir_when_trash_dir_and_history_not_exists(self):
        with (patch("src.make_reserve_copy.open") as mock_open,
              patch("os.path.exists") as mock_exists,
              patch("os.path.isfile") as mock_isfile,
              patch("os.path.isdir") as mock_isdir,
